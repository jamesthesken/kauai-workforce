...
export default function Dropdown({ value, onChange }: any) {
  return (
    ...
    >
      ...
      >
        <Listbox.Options className="absolute right-0 z-10 mt-2 w-56 origin-top-right rounded-md bg-gray-700 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
          <div className="py-1">
